...
# --- Punishment reports ---
PUNISHMENT_REPORTS_ENABLED = os.getenv("PUNISHMENT_REPORTS_ENABLED", "False") == "True"

PUNISHMENT_CHAT_ID = int(os.getenv("PUNISHMENT_CHAT_ID", "0"))
PUNISHMENT_SOURCE_TOPIC_ID = int(os.getenv("PUNISHMENT_SOURCE_TOPIC_ID", "0"))
PUNISHMENT_REPORT_TOPIC_ID = int(os.getenv("PUNISHMENT_REPORT_TOPIC_ID", "0"))